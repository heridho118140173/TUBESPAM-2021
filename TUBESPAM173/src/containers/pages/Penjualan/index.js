...
import DataPenjualan from '../../../component/molecule/DataPenjualan';
...
export default class KelolaData extends Component {
    ...
    return (
        ...
        this.state.listData.map((val,index)=>(
         ...
         <DataPenjualan key={index} nama={val.namabarang} harga={val.harga} id={val.id} navigation={this.props.navigation} />
